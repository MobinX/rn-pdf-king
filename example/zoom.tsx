...
/**
 * Payload for panning update event
 */
export interface PanningUpdateEvent {
  x: number
  y: number
  translationX: number
  translationY: number
...
export interface UseZoomGestureProps {
  ...
  itemWidth?: number
  /**
   * Callback fired continuously while panning.
   */
  onPanningUpdate?: (event: PanningUpdateEvent) => void
  /**
...
export interface UseZoomGestureReturn {
  ...
  virtualTranslationX: SharedValue<number>
  virtualTranslationY: SharedValue<number>
...
export default function Zoom(
  ...
  const {
    ...
    translateX: transX,
    translateY: transY,
  } = useZoomGesture({ ...rest, onPanningUpdate, onPanningStart, onPanningEnd, disableVerticalPan })
